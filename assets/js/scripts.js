...
jQuery(document).ready(function() {
    ...
    */
    $('.top-content').backstretch("assets/img/backgrounds/slowmo.jpg");
    $('.testimonials-container').backstretch("assets/img/backgrounds/slowmo.jpg");
    $('.how-it-works-container').backstretch("assets/img/backgrounds/slowmo.jpg");
    $('.call-to-action-container').backstretch("assets/img/backgrounds/slowmo.jpg");
